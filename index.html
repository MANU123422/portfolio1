...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <body>
        <h2>! BIENVENU Chez Dévellopeur Fullstack <!DOCTYPE html>
      </body>
      </html> <span> <br> <?=$data['title']?> <br> </span> <?=$data['place']?></h2>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link active" href="#header">Acceuil</a></li>
          <li><a class="nav-link" href="#about">A propos de moi</a></li>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Emmanuel Gnoprou</h4>
            <p><em> Ingénieur Reseau Informatique et télécommunication , expert en developpement full stack avec 3 ans d'expériences dans la conception et la réalisation de sites web et d'application mobile, responsable et productifs . </em></p>
            <p>
            <ul>
              <li>Abidjan, Yopougon non loin du collège saint louis </li>
              <li>+225 0700082030</li>
              <li>emmanuelgnoprou31@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            <h4>Master Reseau informatique et télécommunication </h4>
            <h5>2024 - 2025</h5>
            <p><em>HEC-Abidjan</em></p>
            <p>Le savoir est une arme</p>
          </div>
          <div class="resume-item">
            <h4>Licence 3 Réseau informatique et Télécommunication</h4>
            <h5>2022 - 2023</h5>
            <p><em>HEC-Abidjan</em></p>
          </div>
          <div class="resume-item">
            <h4>BTS Réseau informatique et Télécommunication</h4>
            <h5>2021 - 2022</h5>
            <p><em>GECOS-FORMATION</em></p>
          </div>
        </div>
        <div class="col-lg-6">
          <h3 class="resume-title">Professional Experience</h3>
          <div class="resume-item">
            <h4>Technicien Sécurité Réseau</h4>
            <h5> 2022 - 2023 </h5>
            <p><em>CENTRE HOSPITALIER UNIVERSITAIRE DE COCODY </em></p>
            <p>
            <ul>
              <li>Effectuez des tests d'intrusion </li>
              <li>Administration du réseau </li>
              <li> Maintenance des equipements Reseaux </li>
              <li> Maintenance de equipement eléctronique </li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            <h4> Promoteur Moov CI</h4>
            <h5>2020 - 2021</h5>
            <p><em> Moov CI</em></p>
            <p>
            <ul>
              <li>Identification des Puces </li>
              <li> Création  de compte client </li>
              <li>ouverture de comptes mobile money</li>
